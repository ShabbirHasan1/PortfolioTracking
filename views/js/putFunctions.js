...
putFunctions.updateAccoutsTableRowOnPriceChange = directEquityFunctions.updateAccoutsTableRowOnPriceChange

// futureFunctions.updateContainerCurrentUnbookedValue = directEquityFunctions.updateContainerCurrentUnbookedValue
putFunctions.updateContainerCurrentUnbookedValue = futureFunctions.updateContainerCurrentUnbookedValue

putFunctions.calculateContainerOpenPosBackExtrapolation = directEquityFunctions.calculateContainerOpenPosBackExtrapolation

putFunctions.setContainerOpenPosRow = directEquityFunctions.setContainerOpenPosRow

putFunctions.setContainerClosePosRow = directEquityFunctions.setContainerClosePosRow

putFunctions.containerAccountsRowProcessTransactionForm = directEquityFunctions.containerAccountsRowProcessTransactionForm

putFunctions.containerAccountsRowAddTransactionForm = function(containerID){
...
putFunctions.displayTransactionFields = function(){
	...
	containerSpecificFeildsContainer.querySelector("#transaction_instrumentID").setAttribute("instrumentTypes", "PE")
...
putFunctions.validateTransactionForm = directEquityFunctions.validateTransactionForm

putFunctions.setTransactionObject = function(){
	var ret = {
...
containerTypeFunctions[6] = putFunctions